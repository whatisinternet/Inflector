...
/// fn table_case_foo_dash_bar_as_foo_bars() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn table_case_FOO_BAR_as_foo_bars() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn table_case_Foo_space_Bar_as_foo_bars() {
///     let mock_string: String = "Foo Bar".to_string();
///     let expected_string: String = "foo_bars".to_string();
///     let asserted_string: String = to_table_case(mock_string);
///     assert!(asserted_string == expected_string);
...
///
/// #[test] #[allow(non_snake_case)]
/// fn table_case_FooBar_as_foo_bars() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_truthy_value_for_is_table_case_when_table() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_table() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_class() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_camel() {
///     let mock_string: String = "fooBarIsAReallyReallyLongString".to_string();
///     let asserted_bool: bool = is_table_case(mock_string);
///     assert!(asserted_bool == false);
/// }
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_screaming_snake() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_snake() {
///     let mock_string: String = "foo_bar_string_that_is_really_really_long".to_string();
///     let asserted_bool: bool = is_table_case(mock_string);
///     assert!(asserted_bool == false);
/// }
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_sentence() {
///     let mock_string: String = "Foo bar string that is really really long".to_string();
///     let asserted_bool: bool = is_table_case(mock_string);
///     assert!(asserted_bool == false);
/// }
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_table_case_when_title() {
