...
/// fn screaming_snake_case_foo_bar_as_foo_bar() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn screaming_snake_case_HTTP_Foo_space_bar_as_foo_bar() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn screaming_snake_case_Foo_space_bar_as_foo_bar() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn screaming_snake_case_FooBar_as_foo_bar() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn screaming_snake_case_fooBar3_as_foo_bar() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_screaming_snake_case_when_sentence() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_screaming_snake_case_when_kebab() {
///     let mock_string: String = "foo-bar-string-that-is-really-really-long".to_string();
///     let asserted_bool: bool = is_screaming_snake_case(mock_string);
///     assert!(asserted_bool == false);
/// }
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_screaming_snake_case_when_class() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_screaming_snake_case_when_title() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_falsey_value_for_is_screaming_snake_case_when_camel() {
///     let mock_string: String = "fooBarIsAReallyReallyLongString".to_string();
///     let asserted_bool: bool = is_screaming_snake_case(mock_string);
///     assert!(asserted_bool == false);
/// }
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_truthy_value_for_is_screaming_snake_case_when_snake() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_truthy_value_for_is_screaming_snake_case_when_snake_with_a_number() {
...
///
/// #[test] #[allow(non_snake_case)]
/// fn returns_truthy_value_for_is_screaming_snake_case_when_snake_with_a_number_snaked() {
